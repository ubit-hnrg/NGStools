...
def main():
    ...
    results = results[['chr','start','end','gene','transcriptID','exonNumber','strand','IntervalLength','dp>=1','dp>=10','dp>=20','dp>=30','dp>=50','dp>=100']] ##agrego chr field for no_restriction bam coverage 1/21
    results.sort_values(by=['chr','start','gene'],inplace = True) ### sort para ordenar los exones en strand - ##agu 8/10
