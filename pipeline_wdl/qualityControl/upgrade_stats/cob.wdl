...
task cobertura {
    ...
    command {   
        ...
        ${toolpath}/bedtools2/bin/coverageBed -a ${ensembl2intervalo_captura} -b ${input_bam} -sort -hist > ${sample_name}.ENS.hist.aux1
...
String N_bases_after
  ...
  ngs_toolpath = ngs_toolpath
    ...
    input:
        ...
        ngs_toolpath = ngs_toolpath,
        sample_name = basename(bam_in, '.bam') #basename(fastp_qual.fastp_stats[idx],'_fastp_report.tsv')#basename(analysis_readybam[idx], '.bam')
    }
