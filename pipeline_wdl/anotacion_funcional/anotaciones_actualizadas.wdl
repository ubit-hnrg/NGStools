...
set -o pipefail
java -Xmx${java_heap_memory_initial} -jar ${path_herramientas}/snpEff/snpEff.jar ${reference_version} -hgvs \
-t -lof -noStats -canon -onlyProtein -c ${path_herramientas}/snpEff/snpEff.config \
...
command {
set -o pipefail
java -Xmx${java_heap_memory_initial} -jar ${path_herramientas}/snpEff/SnpSift.jar ${parametros} ${database} \
...
command {
set -o pipefail
java -Xmx${java_heap_memory_initial} -jar ${path_herramientas}/snpEff/SnpSift.jar ${parametros} \
${input_vcf} > ${sample_name}.${nombre_step}.vcf
