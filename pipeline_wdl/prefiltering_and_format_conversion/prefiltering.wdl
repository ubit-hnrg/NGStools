...
task fastq2ubam {
    ...
    command <<<
        ...
        java -Xmx8G -jar ${toolpath}${gatk4_jar} FastqToSam --FASTQ=${R1_fastq_cleaned_gz} --FASTQ2=${R2_fastq_cleaned_gz} --OUTPUT=${sample_name}_${Flowcell}_Lane${Lane_Number}_u.bam --READ_GROUP_NAME=$rgid --SAMPLE_NAME=${sample_name} --LIBRARY_NAME=${LIBRARY} --PLATFORM=${PLATFORM}
    >>>
