...
#perl ${toolpath}annovar/table_annovar.pl ${vcf_in} ${annovar_dbpath} -vcfinput  -buildver hg19 -remove -out ${out_prefix} -thread 4 -protocol dbnsfp42a,gnomad211_exome,gnomad211_genome,intervar_20180118 -operation f,f,f,f 
...
call annovar {
input:
vcf_in = step_2_bptools_variant_annotation.bptools_out,#step6_Snpsift_GWASCat.salida_Snpsift,
...
call exon_distance {
    input:
    vcf_ok = intervar_postprocessing.salida_intervar, #hnrg_freq.out_vcfanno,#final_annot.salida_Snpsift,
