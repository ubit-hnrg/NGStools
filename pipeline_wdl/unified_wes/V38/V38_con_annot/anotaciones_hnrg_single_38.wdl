...
task intervar_postprocessing {
    ...
    python3 ${ngs_toolpath}/pipeline_wdl/anotacion_funcional/create_InterVarDB_38.py -i=${multianno_txt} -o $vcfDB
...
call exon_distance {
    input:
    vcf_ok = step11_clinVar_final_annot.salida_Snpsift, #step12_clinVar.salida_Snpsift, #final_annot.salida_Snpsift,
