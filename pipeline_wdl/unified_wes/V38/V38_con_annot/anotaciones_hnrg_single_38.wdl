...
perl ${toolpath}2024/annovar/table_annovar.pl ${vcf_in} ${annovar_dbpath} -vcfinput -buildver hg38 -thread 4 -remove -out ${out_prefix} -protocol gnomad40_exome,gnomad40_genome,intervar_20180118 -operation f,f,f -nastring . -polish -intronhgvs 30
