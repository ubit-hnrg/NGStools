...
task coord_generator {
  ...
  command <<<
    ...
    ###merged
    sort -k1,1 -k2,2n intervalo_b37_padded.bed | ${toolpath}bedtools2/bin/mergeBed -i /dev/stdout -d ${merge_tolerance} > intervalo_b37_padded_merged_${merge_tolerance}.bed
  ...
  output {
    File padded_coord = "intervalo_b37_padded.bed"
