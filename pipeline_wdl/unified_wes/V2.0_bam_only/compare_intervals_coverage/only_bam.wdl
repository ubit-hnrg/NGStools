...
task CheckContamination {
  ...
  File contamination_sites_ud = '/data/new_dbs/grch38/hg38/references_hg38_v0_Homo_sapiens_assembly38.contam.UD'
  File contamination_sites_bed = '/data/new_dbs/grch38/hg38/references_hg38_v0_Homo_sapiens_assembly38.contam.bed'
  File contamination_sites_mu = '/data/new_dbs/grch38/hg38/references_hg38_v0_Homo_sapiens_assembly38.contam.mu'
  File ref_fasta
  ...
  #/home/hnrg/HNRG-pipeline-V0.1/tools/
  command <<<
    set -e
...
task MarkDuplicates {
  ...
  String toolpath
   ...
   ####agrega chusmiar
   #CLEAR_DT="false" \
   #   ADD_PG_TAG_TO_READS=false ##esto quita bastante info.markduplicates etc. 
  command {
...
task HaplotypeCaller {
  ...
  #  -G StandardAnnotation -G StandardHCAnnotation ~{true="-G AS_StandardAnnotation" false="" make_gvcf} \
     ...
     #quita max-alternative-allele; pair-hmm; smith;us new;qual;
      #-R ~{ref_fasta} \
      #-I ~{input_bam} \
      #-L ~{interval_list} \
      #-O ~{output_filename} \
      ...
      #-GQB 10 -GQB 20 -GQB 30 -GQB 40 -GQB 50 -GQB 60 -GQB 70 -GQB 80 -GQB 90 \
      #~{true="-ERC GVCF" false="" make_gvcf} \
#-ip lo sacan; -max-alternatives-allele tambien
...
####nueva version le agrega --validation type to exclude = ALLELES
  command {
    java -Xms3000m -jar ${toolpath}${gatk_jar} \
      ValidateVariants \
      -V ${input_vcf} \
...
##############hasta aca, bam SIN restricciones
