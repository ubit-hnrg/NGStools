##### V2 pipeline UIT enero 2021
## pipeline para generar bam sin restricciones
## 
...
workflow main_workflow {
 ...
 scatter (sample_txt in array_of_samples_txt)  {
  ...
  #       input_gvcf = only_bam_wflw.output_gvcf,
  #       input_gvcf_index = only_bam_wflw.output_gvcf_index,
...
#####creo aca va lo nuevo con todas las N_bases del fastq. Creo...
   #Array[Int] N_reads_bams = only_bam_wflw.N_reads_bam
   #Array[String] N_reads_bams = only_bam_wflw.N_reads_bam



  ### intervalo para quality control -> coord_generator.interval_restricted

#  Array[File] archivos_a_borrar3 = only_bam_wflw.borrar_SortandFix #,"${}"]
