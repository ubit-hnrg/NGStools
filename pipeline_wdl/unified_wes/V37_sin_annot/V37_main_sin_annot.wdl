##### V37 pipeline UIT marzo 2024
## alineamiento a hg37 con updates de programas
## 



import './fastq2ubam_37.wdl' as fastq2ubam #1
import './ubam2bwa_37.wdl' as ubam2bwa #2
import './bam2gvcf_37.wdl' as bamtogvcf #3
import './jointgenotype_single_37.wdl' as single_genotypeGVCF #4
import './qc_37.wdl' as qual_control #5
...
task coord_generator {
  ...
  command <<<
    ...
    ${toolpath}bedtools-2.31.1/bedtools2/bin/slopBed -i ${intervalo_captura} -g ${chromosome_length} -b ${padding} | ${toolpath}bedtools-2.31.1/bedtools2/bin/sortBed -i - -g ${chromosome_length} > ${library_name}_padded_${padding}.bed 

     ####Exon_restricted interval for quality_control  ${library_name}_padded_${padding}.bed | sort -k1,1 -k2,2n -V 
    ${toolpath}bedtools-2.31.1/bedtools2/bin/intersectBed -a ${generic_exon_coords} -b ${intervalo_captura}| ${toolpath}bedtools-2.31.1/bedtools2/bin/sortBed -i -g ${chromosome_length} - > exon_restricted2_${library_name}.bed
...
workflow main_workflow {
  ...
  String? pipeline_version = "V37_sin_annot" ###no me lo toma el input como default
  ...
  File dbSNP_vcf = "/home/hnrg/HNRG-pipeline-V0.1/new_dbs/2021/dbSNP155_GRCh37_ensembl_ok.vcf.gz"
  File dbSNP_vcf_index = "/home/hnrg/HNRG-pipeline-V0.1/new_dbs/2021/dbSNP155_GRCh37_ensembl_ok.vcf.gz.tbi"
  ###bam2gvcf input
  Array[File] known_indels_sites_VCFs = ["/home/hnrg/HNRG-pipeline-V0.1/dbs/preprocessing_dbs/Mills_and_1000G_gold_standard.indels.b37.vcf.gz","/home/hnrg/HNRG-pipeline-V0.1/dbs/preprocessing_dbs/1000G_phase1.indels.b37.vcf.gz"]
  Array[File] known_indels_sites_indices = ["/home/hnrg/HNRG-pipeline-V0.1/dbs/preprocessing_dbs/Mills_and_1000G_gold_standard.indels.b37.vcf.gz.tbi","/home/hnrg/HNRG-pipeline-V0.1/dbs/preprocessing_dbs/1000G_phase1.indels.b37.vcf.gz.tbi"]
  ...
  Int gatk_gkl_pairhmm_threads = "2"
  ...
  ##################anotacion funcional
  String reference_version = "GRCh37.87"
