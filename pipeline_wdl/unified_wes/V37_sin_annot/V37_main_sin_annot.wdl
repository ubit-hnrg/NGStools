...
task coord_generator {
  ...
  command <<<
    ...
    ${toolpath}bedtools-2.31.1/bedtools2/bin/intersectBed -a ${generic_exon_coords} -b ${intervalo_captura}| ${toolpath}bedtools-2.31.1/bedtools2/bin/sortBed
     -g ${chromosome_length} - > exon_restricted2_${library_name}.bed
