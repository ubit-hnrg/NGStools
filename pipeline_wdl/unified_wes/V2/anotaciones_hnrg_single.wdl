############################
### pipeline anotacion funcional single
#################
...
output {
 ...
 File singleanno_txt = "${out_prefix}.hg19_singleanno.txt"
 File singleanno_vcf = "${out_prefix}.hg19_singleanno.vcf"
}
...
call intervar_postprocessing {
    input:
        vcfinput = annovar.singleanno_vcf,
        multianno_txt = annovar.singleanno_txt,
        toolpath = toolpath,
        samplename1 = samplename1
