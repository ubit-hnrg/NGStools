...
call bptools as step_0_bptools_mma {
    ...
    samplename1 = samplename1,
    parametros = "-mma",
    input_vcf = step_1_Snpeff.step1_snpeff,#step4_1000Genomes.salida_Snpsift,#step3_dbSNP.salida_Snpsift,#input_vcf,
    toolpath = toolpath,
    java_heap_memory_initial = java_heap_memory_initial,
...
# }
 ...
 input:
    input_vcf = step3_dbSNP.salida_Snpsift,#step12_clinVar.salida_Snpsift,#step_0_bptools_mma.bptools_out,#step13_pharmGKB.salida_Snpsift, 
    samplename1 = samplename1,
    toolpath = toolpath,
