...
input:
    samplename1 = samplename1,
    parametros = "annotate",
    input_vcf = input_vcf,#step_0_bptools_mma.bptools_out,#step4_1000Genomes.salida_Snpsift,#,#step_2_bptools_variant_annotation.bptools_out,
    toolpath = toolpath,
    java_heap_memory_initial = java_heap_memory_initial,
...
# }
 ...
 call symlink_important_files {
         input:
        output_to_save = step3_dbSNP.salida_Snpsift,#step_0_bptools_mma.bptools_out,#,#hnrg_freq.out_vcfanno,#final_annot.salida_Snpsift,
