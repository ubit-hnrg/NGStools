...
perl ${toolpath}annovar/table_annovar.pl  ${vcf_in} ${annovar_dbpath} -vcfinput -buildver hg19 -remove -out ${out_prefix} -protocol avsnp150,1000g2015aug_all,intervar_20180118,gnomad_exome,gnomad_genome,refGene,knownGene -operation  f,f,f,f,f,g,g #-nastring . -otherinfo
