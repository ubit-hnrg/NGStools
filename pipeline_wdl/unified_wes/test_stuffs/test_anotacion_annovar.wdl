...
input:
    samplename1 = samplename1,
    input_vcf = step_0_bptools_mma.bptools_out,#input_vcf,#step_0_bptools_mma.bptools_out,#input_vcf,#,
    toolpath = toolpath,
    java_heap_memory_initial = java_heap_memory_initial,
...
# }
 ...
 call symlink_important_files {
         input:
        output_to_save = hnrg_freq.out_vcfanno,#intervar_postprocessing.salida_intervar,#dbsnp.salida_Snpsift,#step4_1000Genomes.salida_Snpsift,# #,#,#,#step_0_bptools_mma.bptools_out,#,#,#,#step3_dbSNP.salida_Snpsift,#,#,#,#hnrg_freq.out_vcfanno,#final_annot.salida_Snpsift,
