...
call annovar {
input:
vcf_in = step7_dbNSFP.salida_Snpsift,#step_1_Snpeff.step1_snpeff,#step3_dbSNP.salida_Snpsift,#,#step3_dbSNP.salida_Snpsift,# ,#input_vcf,#step_0_bptools_mma.bptools_out,#input_vcf,#step6_Snpsift_GWASCat.salida_Snpsift,
...
# }
 ...
 call symlink_important_files {
         input:
        output_to_save = intervar_postprocessing.salida_intervar,#dbsnp.salida_Snpsift,#step4_1000Genomes.salida_Snpsift,# #,#,#,#step_0_bptools_mma.bptools_out,#,#,#,#step3_dbSNP.salida_Snpsift,#,#,#,#hnrg_freq.out_vcfanno,#final_annot.salida_Snpsift,
