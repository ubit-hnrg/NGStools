...
perl ${toolpath}/annovar/table_annovar.pl ${vcf_in} ${annovar_dbpath} -vcfinput  -buildver hg19 -thread 4 -remove -out ${out_prefix} -protocol dbnsfp42a,gnomad_exome,gnomad_genome,intervar_20180118 -operation f,f,f,f 
...
task hnrg_freq {
    ...
    command {
        ${toolpath}/vcfanno_linux64 -p 4 ${config_file_vcfanno_toml} ${input_vcf} > ${samplename1}.${nombre_step}.vcf
...
input:
 ...
 input:
    ...
    config_file_vcfanno_toml = config_file_vcfanno_toml
...
input:
    ...
    toolpath = toolpath,
    java_heap_memory_initial = java_heap_memory_initial,
    nombre_step = "final_annot_"+db_version
 ...
 call symlink_important_files {
        ...
        path_vcf_original = path_vcf_original
