...
import './jointgenotype_single_38_no_annot.wdl' as single_genotypeGVCF #4
...
workflow main_workflow {
  ...
  ########## referencia
  File ref_fasta = "/data/new_dbs/grch38/hg38_broad/Homo_sapiens_assembly38.fasta"  #/data/new_dbs/grch38/GRCh38_alignment.fa.ann"
  File ref_fasta_index = "/data/new_dbs/grch38/hg38_broad/Homo_sapiens_assembly38.fasta.fai" #"/data/new_dbs/grch38/GRCh38_alignment.fa.fai"
  File ref_dict = "/data/new_dbs/grch38/hg38_broad/Homo_sapiens_assembly38.dict"# "/data/new_dbs/grch38/GRCh38_alignment.dict"
  File ref_amb = "/data/new_dbs/grch38/hg38_broad/Homo_sapiens_assembly38.fasta.64.amb"# " /data/new_dbs/grch38/GRCh38_alignment.fa.amb"
  File ref_ann = "/data/new_dbs/grch38/hg38_broad/Homo_sapiens_assembly38.fasta.64.ann"# "/data/new_dbs/grch38/GRCh38_alignment.fa.ann"
  File ref_bwt = "/data/new_dbs/grch38/hg38_broad/Homo_sapiens_assembly38.fasta.64.bwt"# "/data/new_dbs/grch38/GRCh38_alignment.fa.bwt"
  File ref_pac = "/data/new_dbs/grch38/hg38_broad/Homo_sapiens_assembly38.fasta.64.pac"# "/data/new_dbs/grch38/GRCh38_alignment.fa.pac"
  File ref_sa = "/data/new_dbs/grch38/hg38_broad/Homo_sapiens_assembly38.fasta.64.sa"# "/data/new_dbs/grch38/GRCh38_alignment.fa.sa"
  File ref_alt = "/data/new_dbs/grch38/hg38_broad/Homo_sapiens_assembly38.fasta.64.alt"  
 ...
 #######Agrego sitios contaminacion
 File contamination_sites_ud = "/data/new_dbs/grch38/intervalos/1000g.phase3.100k.b38.vcf.gz.dat.UD" #1000g.phase3.100k.b38.vcf.gz.dat.UD
 File contamination_sites_bed = "/data/new_dbs/grch38/intervalos/1000g.phase3.100k.b38.vcf.gz.dat.bed" #1000g.phase3.100k.b38.vcf.gz.dat.bed
 File contamination_sites_mu = "/data/new_dbs/grch38/intervalos/1000g.phase3.100k.b38.vcf.gz.dat.mu" #1000g.phase3.100k.b38.vcf.gz.dat.mu
...
#File haplotype_database_file = "/data/new_dbs/grch38/intervalos/Homo_sapiens_assembly38.haplotype_database.txt" #Homo_sapiens_assembly38.haplotype_database.txt
  ...
  String db_annovar = "/home/hnrg/HNRG-pipeline-V0.1/dbs/hg38_annovar/" #path annovar 
...
###########
  File hapmap_resource_vcf = "/data/new_dbs/grch38/bundle_gatk_hg38/hapmap_3.3.hg38.vcf.gz"
  File hapmap_resource_vcf_index = "/data/new_dbs/grch38/bundle_gatk_hg38/hapmap_3.3.hg38.vcf.gz.tbi"
  File omni_resource_vcf = "/data/new_dbs/grch38/bundle_gatk_hg38/1000G_omni2.5.hg38.vcf.gz"
  File omni_resource_vcf_index = "/data/new_dbs/grch38/bundle_gatk_hg38/1000G_omni2.5.hg38.vcf.gz.tbi"
  File one_thousand_genomes_resource_vcf = "/data/new_dbs/grch38/bundle_gatk_hg38/1000G_phase1.snps.high_confidence.hg38.vcf.gz"
  File one_thousand_genomes_resource_vcf_index = "/data/new_dbs/grch38/bundle_gatk_hg38/1000G_phase1.snps.high_confidence.hg38.vcf.gz.tbi"
  File mills_resource_vcf = "/data/new_dbs/grch38/bundle_gatk_hg38/Mills_and_1000G_gold_standard.indels.hg38.vcf.gz"
  File mills_resource_vcf_index = "/data/new_dbs/grch38/bundle_gatk_hg38/Mills_and_1000G_gold_standard.indels.hg38.vcf.gz.tbi"
  File axiomPoly_resource_vcf = "/data/new_dbs/grch38/bundle_gatk_hg38/Axiom_Exome_Plus.genotypes.all_populations.poly.hg38.vcf.gz"
  File axiomPoly_resource_vcf_index = "/data/new_dbs/grch38/bundle_gatk_hg38/Axiom_Exome_Plus.genotypes.all_populations.poly.hg38.vcf.gz.tbi"
