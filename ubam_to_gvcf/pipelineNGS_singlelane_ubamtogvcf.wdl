##### pipeline para obtener un GVCF a partir de un uBAM (dic 2018)
...
task BwaMem {
  ...
  String path_herramientas
    ...
    /tools/bwa-0.7.17/./bwa mem -K 100000000 -p -v 3 -t 4 ${ref_fasta} ${fastaentrada} > ${output_bam_basename}.bam
    >>>
