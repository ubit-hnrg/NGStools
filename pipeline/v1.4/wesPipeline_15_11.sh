...
declare -A GRCh37=(["HGREF"]="/home/bitgenia/bundle/hgref" ["BT2_REF"]="/home/bitgenia/bundle/hgref/human_g1k_v37_decoy" ["REF"]="/home/bitgenia/bundle/hgref/human_g1k_v37_decoy.fasta" ["KGINDELS"]="/home/bitgenia/bundle/hgref/1000G_phase1.indels.b37.vcf" ["MILLSINDELS"]="/home/bitgenia/bundle/hgref/Mills_and_1000G_gold_standard.indels.b37.vcf" ["DBSNP"]="/home/bitgenia/bundle/hgref/dbSNP_144_GRCH37.vcf.gz" ["GWASCAT"]="/home/bitgenia/bundle/hgref/gwascatalog.txt"  ["GWASCAT_ADJUSTED"]="/home/bitgenia/bundle/hgref/gwascatalog_adjusted.vcf" ["EVS"]="/home/bitgenia/bundle/hgref/ESP6500SI-V2-SSA137.snps_indels.vcf" ["CADD"]="/home/bitgenia/bundle/hgref/CADD_1000G.vcf" ["CLNVAR"]="/home/bitgenia/bundle/hgref/clinvar_20160502.vcf" ["PHARMGKB"]="/home/bitgenia/bundle/hgref/PharmGKBvcf_2016.vcf" ["HAPMAP"]="/home/bitgenia/bundle/hgref/hapmap_3.3.b37.vcf" ["KOMNI"]="/home/bitgenia/bundle/hgref/1000G_omni2.5.b37.vcf" ["KNOWNVARS"]="/home/bitgenia/scripts/known_variants_analysis-devel/grch37mybaby525.vcf" ["DBNSFP"]="/home/bitgenia/bundle/hgref/dbNSFP2.9.txt.gz" ["GRCH_VERSION"]="GRCh37.75");


declare -A hg19=(["HGREF"]="/home/bitgenia/bundle/hg19" ["BT2_REF"]="/home/bitgenia/bundle/hg19" ["REF"]="/home/bitgenia/bundle/hg19/ucsc.hg19.fasta" ["KGINDELS"]="/home/bitgenia/bundle/hg19/1000G_phase1.indels.hg19.sites.vcf" ["MILLSINDELS"]="/home/bitgenia/bundle/hg19/Mills_and_1000G_gold_standard.indels.hg19.sites.vcf" ["DBSNP"]="/home/bitgenia/bundle/hg19/dbsnp_144.hg19.vcf.gz" ["GWASCAT"]="/home/bitgenia/bundle/hg19/gwascatalog.txt" ["GWASCAT_ADJUSTED"]="/home/bitgenia/bundle/hg19/gwascatalog_adjusted.vcf" ["EVS"]="/home/bitgenia/bundle/hg19/ESP6500SI-V2-SSA137.snps_indels.vcf" ["CADD"]="/home/bitgenia/bundle/hg19/CADD_1000G.vcf" ["CLNVAR"]="/home/bitgenia/bundle/hg19/clinvar_20160502.vcf" ["PHARMGKB"]="/home/bitgenia/bundle/hg19/PharmGKBvcfhg19_2016.vcf" ["HAPMAP"]="/home/bitgenia/bundle/hg19/hapmap_3.3.hg19.sites.vcf" ["KOMNI"]="/home/bitgenia/bundle/hg19/1000G_omni2.5.hg19.sites.vcf" ["KNOWNVARS"]="/home/bitgenia/scripts/known_variants_analysis-devel/clinvar_Result/hg19mybaby525.vcf" ["DBNSFP"]="/home/bitgenia/bundle/hg19/dbNSFP2.9.txt.gz" ["GRCH_VERSION"]="hg19");
...
declare -A params=(["XMX"]="6g" ["NT"]="4" ["NCT"]="8" ["QFILTER_READS"]="10" ["MINPRUN"]="3" ["CALL"]="30.0" ["EMIT"]="10.0");
...
declare -A readGroups=(["LB"]="1" ["PL"]="ILLUMINA" ["PU"]="unknown" ["ID"]="1" ["CN"]="CEDIE" ["DS"]="" ["DT"]="$(date)" ["PI"]="");
...
function functionalAnnotation {
    ...
    echo "$(date) Running Sample $SM, SnpEff Annotation Script - Step 3: Annotate with dbSNP144"

    INPUTFILE=$OUTPUTFILE
    OUTPUTFILE=$RESULT/$PREFIX\_dbSNP144_snpEff_annot.vcf

    /usr/bin/time -a -f "%C,%e,%K,%M,%t,%I/%O,%P,%W,%c,%w" -o $TIMELOG/$PREFIX\_time.log.csv java -Xmx${params["XMX"]} -jar  ${tools["SNPEFF"]}/SnpSift.jar annotate ${references["DBSNP"]} $INPUTFILE > $OUTPUTFILE 2> $LOG/$PREFIX\_Step3_dbSNP144.error.log

    if [ "$?" -ne 0 ]
     then
        echo "## ERROR: Annotate with dbSNP144"
    ...
    INPUTFILE=$OUTPUTFILE
    OUTPUTFILE=$RESULT/$PREFIX\_1000G_dbSNP144_snpEff_annot.vcf
    ...
    INPUTFILE=$OUTPUTFILE
    OUTPUTFILE=$RESULT/$PREFIX\_hapmap_1000G_dbSNP144_snpEff_annot.vcf
    ...
    INPUTFILE=$OUTPUTFILE
    OUTPUTFILE=$RESULT/$PREFIX\_GWASCat_hapmap_1000G_dbSNP144_snpEff_annot.vcf
    ...
    INPUTFILE=$OUTPUTFILE
    OUTPUTFILE=$RESULT/$PREFIX\_dbNSFP_GWASCat_hapmap_1000G_dbSNP144_snpEff_annot.vcf
    ...
    INPUTFILE=$OUTPUTFILE
    OUTPUTFILE=$RESULT/$PREFIX\_VarType_dbNSFP_GWASCat_hapmap_1000G_dbSNP144_snpEff_annot.vcf
    ...
    INPUTFILE=$OUTPUTFILE
    OUTPUTFILE=$RESULT/$PREFIX\_EVS_VarType_dbNSFP_GWASCat_hapmap_1000G_dbSNP144_snpEff_annot.vcf
    ...
    INPUTFILE=$OUTPUTFILE
    OUTPUTFILE=$RESULT/$PREFIX\_PhastCons_EVS_VarType_dbNSFP_GWASCat_hapmap_1000G_dbSNP144_snpEff_annot.vcf
    ...
    INPUTFILE=$OUTPUTFILE
    OUTPUTFILE=$RESULT/$PREFIX\_CADD_PhastCons_EVS_VarType_dbNSFP_GWASCat_hapmap_1000G_dbSNP144_snpEff_annot.vcf
    ...
    echo "$(date) Running Sample $SM, SSnpEff Annotation Script - Step 12: Annotate with ClinVar"

    INPUTFILE=$OUTPUTFILE
    OUTPUTFILE=$RESULT/$PREFIX\_CLNVAR_CADD_PhastCons_EVS_VarType_dbNSFP_GWASCat_hapmap_1000G_dbSNP144_snpEff_annot.vcf
